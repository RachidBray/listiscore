...
- **Owner widget** — a widget / `[lhs_health]` shortcode / Gutenberg block showing the score, band, and a recommendations list sorted by potential point gain, visible to the listing owner and admins (optionally public).
